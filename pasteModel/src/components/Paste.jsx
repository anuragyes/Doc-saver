...
const Paste = () => {
  ...
  return (
    <div className="w-full h-full border-black bg-slate-300 py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        {/* Search */}
        <div className="w-full  border-black  flex gap-3 px-4 py-2  rounded-[0.3rem] border border-[rgba(128,121,121,0.3)]  mt-6  font-semibold text-2xl"  >
          <input
            type="search"
        ...
        {/* All Pastes */}
        <div className=" border-black  flex flex-col border border-[rgba(128,121,121,0.3)] py-4 rounded-[0.4rem]">
